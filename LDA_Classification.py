...
print("Computational time for Training (LDA) = ", training_time.microseconds, " microseconds")
print("Computational time for Teasting (LDA) = ", testing_time.microseconds, " microseconds")
